    ...
    <div id="skills-section">
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-rows-1 gap-20 text-center mx-20">
            <div className="row-span-1 space-y-16 w-full">
              <div className="w-full border rounded-lg bg-white shadow-xxl transition duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl dark:hover:shadow-gray-400/40 hover:text-blue-600">
